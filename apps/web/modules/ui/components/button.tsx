...
const buttonVariants = cva(
  'inline-flex items-center justify-center text-base font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-[#CEAA89] text-primary-foreground hover:bg-[#CEAA89]/90',
        error:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-input bg-transparent text-primary hover:bg-[#CEAA89]/10',
        secondary:
          'bg-[#F7EBDF] text-secondary-foreground hover:bg-[#F7EBDF]/80',
        ghost: 'text-primary hover:bg-[#CEAA89]/10 hover:text-primary',
