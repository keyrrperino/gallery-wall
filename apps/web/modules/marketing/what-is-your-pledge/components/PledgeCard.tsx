...
export function PledgeCard({
  ...
  if (style === PledgeStyleEnum.SUPPORT) {
    return (
      <div className="w-[600px] h-[600px] flex flex-col items-center bg-[#cfab88] p-3 leading-none gap-5">
  ...
  if (style === PledgeStyleEnum.FUTURE) {
    return (
      <div className="w-[600px] h-[600px] relative bg-[#F7EBDF] flex flex-col justify-between gap-3 px-[25px] py-4">
        {topText && (
  ...
  if (style === PledgeStyleEnum.CARE) {
    return (
      <div className="w-[600px] h-[600px] relative bg-blue flex flex-col items-start justify-end p-10">
