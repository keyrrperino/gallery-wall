...
const SnapButton: React.FC<SnapButtonProps> = ({ onClick }) => {
  ...
  return (
    <button
      className={`h-[10vh] w-[10vh] md:h-[7vh] md:w-[7vh] font-button-base flex items-center justify-normal outline-none transition-all duration-300 
