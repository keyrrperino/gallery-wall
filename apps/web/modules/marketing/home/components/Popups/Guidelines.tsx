      ...
      <div className="relative max-w-[750px] p-2 xl:max-w-[450px] xl:scale-75">
        <div className="relative z-10">
          ...
          <p className="mb-12 text-[2vh] leading-tight text-white xl:text-xl">
            You only have 1 minute to take your photos. Three photos will be
            taken in a row.
          </p>
          ...
          <p className="mb-12 text-[2vh] leading-tight text-white xl:text-xl">
            Retakes can be done within the 1 minute period. If time runs out,
          ...
          <p className="mb-12 text-[2vh] leading-tight text-white xl:text-xl">
            Choose one from the three options. While waiting for your photo to
            print, you can choose to email yourself a copy.
          </p>

          <div className="flex justify-center">
            <SimpleButton onClick={onClose}>Proceed</SimpleButton>
          </div>
        </div>
      </div>
    </div>
